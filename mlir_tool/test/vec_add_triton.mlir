...
//
// -----------------------------------------------------------------------------
// Triton vector-add kernel (BLOCK_SIZE=32) — mirrors the Triton 01-vector-add
// tutorial. The converter should produce output structurally matching
// PTOAS's vadd_triton_style.pto (multicore, scf.if tail, 1x32 tiles).
// -----------------------------------------------------------------------------
//
module {
